...
class OfflineElePlanner():
    ...
    def reinit_map(
        self,
        a_start_cost_threshold: float,
        safe_cost_margin: float,
        resolution: float,
        num_layers: int,
        step_cost_weight: float,
        cost_map: numpy.ndarray[numpy.float64, _Shape[m, n]],
        height_map: numpy.ndarray[numpy.float64, _Shape[m, n]],
        ceiling: numpy.ndarray[numpy.float64, _Shape[m, n]],
        ele_map: numpy.ndarray[numpy.float64, _Shape[m, n]],
        grad_x: numpy.ndarray[numpy.float64, _Shape[m, n]],
        grad_y: numpy.ndarray[numpy.float64, _Shape[m, n]]
    ) -> None: ...
    def init_planner(self, arg0: float, arg1: float, arg2: float, arg3: int, arg4: numpy.ndarray[numpy.float64, _Shape[m, n]], arg5: numpy.ndarray[numpy.float64, _Shape[m, n]], arg6: numpy.ndarray[numpy.float64, _Shape[m, n]], arg7: numpy.ndarray[numpy.float64, _Shape[m, n]], arg8: numpy.ndarray[numpy.float64, _Shape[m, n]], arg9: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> None: ...
